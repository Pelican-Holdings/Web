    ...
    <div>
      ...
      <section className="mb-8">
        ...
        <p className="text-justify">
          ...
          four numbers of 20,000 liters bowsers for bitumen transport, two units
          of 6,000 liters emulsion transport bowsers, and four numbers of
          ten-wheel trucks for barrel transportation.
        </p>
      </section>
